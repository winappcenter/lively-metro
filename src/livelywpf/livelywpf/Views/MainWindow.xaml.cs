...
namespace livelywpf.Views
{
    ...
    public partial class MainWindow : ChromelessWindow
    {
        ...
        private void NavigatePage(string tag)
        {
            switch (tag)
            {
                ...
                case "add":
                    ...
                    break;
                case "videocutter":
                    ContentFrame.Navigate(typeof(VideoCutterView), new Uri("Views/VideoCutterView.xaml", UriKind.Relative), new EntranceNavigationTransitionInfo());
                    break;
                case "about":
        ...
        private void Window_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                if (!App.settings.IsRated)
                {
                    ReviewUs review = new ReviewUs();
                    review.Topmost = true;
                    review.WindowStartupLocation = WindowStartupLocation.CenterScreen;
                    review.ShowDialog();
                }
            }
        ...
        private void SfNavigationDrawer_ItemClicked(object sender, Syncfusion.UI.Xaml.NavigationDrawer.NavigationItemClickedEventArgs e)
        {
            if (e.Item != null)
            {
                var navItemTag = e.Item.Tag.ToString();
                NavigatePage(navItemTag);
            }
        }
    }
