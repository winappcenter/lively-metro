                ...
                case AppTheme.Light:
                    {
                        ...
                        SfSkinManager.SetTheme(App.Services.GetRequiredService<MainWindow>(), new Theme("MaterialLight"));
                ...
                case AppTheme.Dark:
                    {
                        ...
                        SfSkinManager.SetTheme(App.Services.GetRequiredService<MainWindow>(), new Theme("MaterialDark"));
                    }
